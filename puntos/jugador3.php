...
<body>
                ...
                <table class="table table-borderless">
                    ...
                    <tr style="max-height: 30px;">
                        ...
                        <td style="width: 14.28%;" colspan="2" class="text-center">
                            ...
                            <a href="result_jugador3.php?txtID=<?php echo $txtID;?>">
    ...
    <script>
        ...
        function incrementarValor1(idCuenta1, valorSuma) {
            ...
            $.ajax({
                url: 'jugador3.php?txtID=' + idCuenta1,
                method: 'POST',
            ...
            if (valor >= limite1) {
                $.ajax({
                    url: 'result_jugador3.php?txtID=' + idCuenta1,
                    method: 'POST',
                    data: { limite1: limite1 },
                    success: function(response) {
                        window.location.href = 'result_jugador3.php?txtID=' + idCuenta1;
                    },
                    error: function(xhr, textStatus, errorThrown) {
                        console.log(xhr.responseText);
                    }
        ...
        function incrementarValor2(idCuenta2, valorSuma) {
            ...
            valorElement.innerText = valor;
            $.ajax({
                url: 'jugador3.php?txtID=' + idCuenta2,
                method: 'POST',
            ...
            if (valor >= limite2) {
                $.ajax({
                    url: 'result_jugador3.php?txtID=' + idCuenta2,
                    method: 'POST',
                    data: { limite2: limite2 },
                    success: function(response) {
                        window.location.href = 'result_jugador3.php?txtID=' + idCuenta2;
                    },
                    error: function(xhr, textStatus, errorThrown) {
                        console.log(xhr.responseText);
                    }
        ...
        function incrementarValor3(idCuenta3, valorSuma) {
            ...
            valorElement.innerText = valor;
            $.ajax({
                url: 'jugador3.php?txtID=' + idCuenta3,
                method: 'POST',
            ...
            if (valor >= limite3) {
                $.ajax({
                    url: 'result_jugador3.php?txtID=' + idCuenta3,
                    method: 'POST',
                    data: { limite3: limite3 },
                    success: function(response) {
                        window.location.href = 'result_jugador3.php?txtID=' + idCuenta3;
                    },
                    error: function(xhr, textStatus, errorThrown) {
                        console.log(xhr.responseText);
                    }
        ...
        function Entrada(idCuenta_entrada, valorSuma) {
            ...
            valorElement.innerText = valor;
            $.ajax({
                url: 'jugador3.php?txtID=' + idCuenta_entrada,
                method: 'POST',
        ...
        function ConteoSerie(conteo, jugador, idCuenta) {
            ...
            $.ajax({
                url: 'jugador3.php?txtID=' + idCuenta,
                method: 'POST',
        ...
        function Stream(idCuentaDetener, comando, estado_video) {
            ...
            if (confirmacion) {
                $.ajax({
                    url: 'jugador3.php?txtID=' + idCuentaDetener,
                    method: 'POST',
