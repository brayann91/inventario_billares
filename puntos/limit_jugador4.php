        ...
        <table class="table table-borderless table-fill m-0">
            ...
            <tr class="table-row">
                ...
                <div class="mb-3 d-flex justify-content-center">
                    ...
                    aria-describedby="helpId" placeholder="999" maxlength="3" inputmode="numeric" onclick="cambiarEstadoTeclado('puntos_jugador3')">
                </div>
                </td>
                <td colspan="1" class="table-cell">
                <div class="mb-3 d-flex justify-content-center">
                    <input type="number" class="form-control form-control-lg w-25 text-center" name="puntos_jugador4" id="puntos_jugador4" 
                    aria-describedby="helpId" placeholder="999" maxlength="3" inputmode="numeric" onclick="cambiarEstadoTeclado('puntos_jugador4')">
                </div>
                </td>
            </tr>
            <tr>
            ...
            <tr class="table-row">
                ...
                <div class="mb-3 d-flex justify-content-center">
                    ...
                    aria-describedby="helpId" placeholder="Juan" maxlength="20" inputmode="text" onclick="cambiarEstadoTeclado('nombre_jugador3')">
                </div>
                </td>
                <td colspan="1" class="table-cell">
                <div class="mb-3 d-flex justify-content-center">
                    <input type="text" class="form-control form-control-lg w-50 text-center" name="nombre_jugador4" id="nombre_jugador4" 
                    aria-describedby="helpId" placeholder="Javier" maxlength="20" inputmode="text" onclick="cambiarEstadoTeclado('nombre_jugador4')">
                </div>
                </td>
            </tr> 
            <tr>
            ...
            <tr>
                <td colspan="4">  
                    ...
                    <a name="borrador_jugador" id="borrador_jugador" class="btn btn-secondary" role="button" onclick="borrarTexto(estado_teclado)"> ← </a>
                </td>
            </tr>
