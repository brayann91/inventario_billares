    ...
    <div class="container-fluid vh-100 d-flex justify-content-center align-items-center p-0">
        <table class="table table-fill m-0">
            ...
            <tr>
                ...
                <td class="table-cell col-2 td"><h1>VS</h1></td>
                <td class="table-cell col-2 td"><h1><?php echo $lista_puntos['jugador3'];?></h1></td>
                <td class="table-cell col-2 td"><h1><?php echo $lista_puntos['jugador4'];?></h1></td>
            </tr>
            <tr>
                <?php 
                $valores  = [$lista_puntos['puntos_jugador1'], $lista_puntos['puntos_jugador2'], $lista_puntos['puntos_jugador3'], $lista_puntos['puntos_jugador4']];
                $resultado  = ["Ganador", "Segundo", "Tercero", "Cuarto"];
                rsort($valores);
                ...
                for ($i = 0; $i < count($valores); $i++) {  
                    if ($valores[$i] == $lista_puntos['puntos_jugador4']){ 
                    ?>
                    <td class="table-cell col-2 td"><h1 ><?php echo $resultado[$i]?></h1></td>
                <?php $i=5;
                    }
            ...
            <tr>
                ...
                <td class="table-cell col-2 td"><h1><?php echo $lista_puntos['puntos_jugador4'];?></h1></td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-cell col-2 td"><h1>
                    <?php if($lista_puntos['entrada'] != 0){ echo intval(($lista_puntos['puntos_jugador4'] * 1000) / $lista_puntos['entrada']);}?>
                </h1></td>
            </tr>
            ...
            <tr>
                ...
                <td class="table-cell col-2 td"><h1><?php echo $lista_puntos['max_serie4'];?></h1></td>
            </tr>
...
function Restablecer(idCuenta) {
    ...
    if (confirmacion) {
        $.ajax({
            url: 'result_jugador4.php?txtID=' + idCuenta,
            method: 'POST',
