...
if(isset($_GET['txtID'])){
    ...
    $sentencia=$conexion->prepare("DELETE FROM cuentas WHERE id_cuenta=:id_cuenta");
...
$sentencia=$conexion->prepare("SELECT * FROM cuentas c INNER JOIN sedes s WHERE c.id_sede=" . $_SESSION['id_sede'] . " GROUP BY c.id_cuenta");
$sentencia->execute();
