...
if ($_POST) {
    ...
    $mensaje = "Se agrego la cantidad de productos Exitosamente";
     ...
     <div class="card-body">
         ...
         <form action="" method="post" enctype="multipart/form-data">
            ...
            ?>
             ...
             <div class="mb-3">
               <label for="cantidad" class="form-label">Cantidad de productos que desea agregar</label>
               <input type="text"
