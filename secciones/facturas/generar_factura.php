<?php
    ...
    $sentencia->bindParam(":id_factura", $txtID);
    $sentencia->execute();
    ...
    $sentencia = $conexion->prepare("UPDATE cuentas SET estado=0 WHERE id_cuenta=:idCuenta AND nombre_cuenta NOT LIKE 'MESA%' AND nombre_cuenta NOT LIKE 'CLIENTE'");
